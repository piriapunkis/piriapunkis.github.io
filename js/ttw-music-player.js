    ...
    $.fn.ttwMusicPlayer = function(playlist, userOptions) {
        ...
        interfaceMgr = function() {
            ...
            function buildInterface() {
                ...
                markup = '<aside id="player" class="ttw-music-player">' +
                    ...
                    //  '            <p class="album-title">Infanto-Juvenil</p>' +
                    //  '            <p class="artist-outer">Por <span class="artist"></span></p>' +
                    //  '        </div>' +
                ...
                $interface = $(markup).css({display:'none', opacity:0}).appendTo('main').slideDown('slow', function() {
